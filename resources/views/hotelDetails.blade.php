    ...
    @foreach ($hotel as $data)
        <div class="container">
            ...
            <div class="hotel">
                <div class="row">
                    <div class="col-12" >
                        <div class="row" style="border-bottom: 2px solid rgb(231, 231, 231)">
                            <div class="col-5">
                            ...
                            <div class="col-4 mt-1">
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <p class="text-muted" style="font-size: 20px;font-weight:900; margin-left:5px">Stok Kamar : {{$data->stok_kamar}}</p>
                                </div>
                            </div>
            ...
            <div>
                <br><br>
                <div id="pesanKamar" class="pesanKamar mt-5" style="max-width: 400px">
                    <h2>Hotel lainnya</h2>
                </div><br>
                <div class="row" style="text-align: center">
                    @foreach ($lainnya as $data)
                        <div class="col-md-4 hover">
                            <a href="/hotel/{{$data->nama_hotel}}" style="color:black; text-decoration:none">
                                <img src="{{ asset('storage/assets/hotel/'.$data->gambar) }}" alt="" style="max-width: 100%;border-radius:10px;height:330px">
